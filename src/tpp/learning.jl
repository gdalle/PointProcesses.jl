...
"""
function integrated_ground_intensity(pp::TemporalPointProcess{M}, h::History{M}) where {M}
    prob = QuadratureProblem((t, pp) -> ground_intensity(pp, h, t), h.tmin, h.tmax, pp)
