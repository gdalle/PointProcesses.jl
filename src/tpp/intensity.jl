...
"""
function intensity(pp::TemporalPointProcess{M}, h::History{M}, t::Float64, m::M) where {M}
...
```
"""
function ground_intensity(pp::TemporalPointProcess{M}, h::History{M}, t::Float64) where {M}
    error("not implemented")
end
